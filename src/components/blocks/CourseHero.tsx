...
export default function CourseHero() {
  return (
    <>
      <div className="absolute left-0 right-0 top-20 z-10 h-[46.375rem]">
        <Image
          src="https://drive.google.com/uc?export=view&id=16GCSrue--rsVsCTjz3h_4tC_ZAvrveWn"
          alt="Hero background image"
          style={{ objectFit: 'cover' }}
          fill
        />
      </div>
      <div className="z-20 flex h-[38.375rem]">
        <div className="mr-14 flex w-[60%] flex-col">
          <div
            className="mb-4 flex-1 rounded bg-cover bg-center bg-no-repeat"
            style={{
          ...
          <div className="flex h-[7.5rem] gap-x-4">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="flex-1 rounded bg-cover bg-center bg-no-repeat"
                style={{
                  backgroundImage: `url('https://dlcdnrog.asus.com/rog/media/160050017840.webp')`,
                }}
              ></div>
        ...
        <div className="flex w-[40%] flex-col">
          ...
          <h4 className="mb-8 text-lg text-gray-300">
            Implement a Dialogue Editor and Quest System and integrate it into
            an RPG project.
          </h4>
